...
const Dashboard = () => {
  ...
  <div className="bg-gray-100">
      <aside
        className="fixed top-0 z-10 ml-[-100%] flex h-screen w-full flex-col justify-between border-r bg-white px-6 pb-3 transition duration-300 md:w-4/12 lg:ml-0 lg:w-[25%] xl:w-[20%] 2xl:w-[15%] dark:border-gray-700"
      >
        <div>
      ...
      <div className="ml-auto mb-6 lg:w-[75%] xl:w-[80%] 2xl:w-[85%]">
        ...
        <div className="px-6 pt-6 2xl:container">
          <div
            className="flex h-[80vh] items-center justify-center rounded-xl"
          >
            <Outlet/>
          </div>
        </div>
