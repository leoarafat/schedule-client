  ...
  return (
    <div>
      <div className="fixed w-full flex items-center justify-between h-14 text-white z-10">
        ...
        <div className="w-full flex justify-end items-center h-14 dark:bg-primary header-right">
      ...
      <div className="fixed flex flex-col top-14 left-0 w-14 hover:w-64 md:w-64 shadow-2xl h-full text-primary transition-all duration-300 border-none z-10 sidebar">
