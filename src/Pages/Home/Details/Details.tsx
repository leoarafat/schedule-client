      ...
      <div className="hero ">
        <div className="hero-content flex-col lg:flex-row-reverse mt-5">
          ...
          <div className="lg:w-8/12 md:w-full mr-auto lg:text-left md:text-left text-center">
            ...
            <p className="pt-6 lg:text-xl md:text-xl text-sm lg:text-left text-center text-accent">
              Never send another "When can you meet?" email again. Get the right
              people together. At the right time. In 3 steps.
            </p>

            <div className="lg:flex md:flex items-center mb-0 md:mt-16 lg:flex-row md:flex-row flex-row-reverse">
              <div className="lg:w-2/12 w-3/12 lg:mr-0 md:mr-auto mx-auto">
                <img
                  src="https://i.ibb.co/ypKL5WZ/undraw-Accept-tfj38.pnghttps://i.ibb.co/1mNgKp8/undraw-Accept-terms-re-lj38.png"
