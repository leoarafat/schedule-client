    ...
    return (
          ...
          <div className="w-full flex flex-col text-center md:text-left md:flex-row shadow bg-white mt-10 mb-10 p-6">
            <div className="w-full md:w-1/5 flex justify-center md:justify-start pb-4">
              <img
                ...
                className="rounded-full shadow h-32 w-32" alt=''
              />
            </div>
        ...
        <aside className="w-full md:w-1/3 flex flex-col items-center px-3">
            ...
            <div className="w-full bg-white shadow flex flex-col my-4 p-6">
                ...
                <a href="/about" className="w-full bg-primary text-white font-bold text-sm uppercase rounded hover:bg-blue-600 flex items-center justify-center px-2 py-3 mt-4">
                    Get to know us
                </a>
            </div>
