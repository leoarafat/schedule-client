...
const ThirtyMins = () => {
  ...
  const [colors, setColors] = useState(Array(thirtyMinsAm && thirtyMinsAm[0]?.slots.length).fill('#0098da'));
  const [colorus, setColorus] = useState(Array(thirtyMinsAm && thirtyMinsAm[0]?.slots.length).fill('#fff'));
  ...
  const [colorsPm, setColorsPm] = useState(Array(thirtyMinsAm && thirtyMinsAm[0]?.slots.length).fill('#0098da'));
  const [colorsPmm, setColorsPmm] = useState(Array(thirtyMinsAm && thirtyMinsAm[0]?.slots.length).fill('#fff'));
