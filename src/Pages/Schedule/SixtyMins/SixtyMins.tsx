...
const SixtyMins = () => {
  ...
  const [colors, setColors] = useState(Array(sixtyMinsAm && sixtyMinsAm[0]?.slots.length).fill('#0098da'));
  const [colorus, setColorus] = useState(Array(sixtyMinsAm && sixtyMinsAm[0]?.slots.length).fill('#fff'));
  ...
  const [colorsPm, setColorsPm] = useState(Array(sixtyMinsAm && sixtyMinsAm[0]?.slots.length).fill('#0098da'));
  const [colorsPmm, setColorsPmm] = useState(Array(sixtyMinsAm && sixtyMinsAm[0]?.slots.length).fill('#fff'));
