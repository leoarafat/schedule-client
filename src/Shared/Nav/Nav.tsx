    ...
    <nav className="navbar bg-base-100 flex items-center mt-5 max-w-[1300px] mx-auto">
      ...
      <div className="navbar-center hidden lg:flex">
        <ul className="menu menu-horizontal px-1 ul-style text-primary">
          <li>
            <Link to={"/"} className="noo-hover link-style">
              Home
            </Link>
          </li>
          <li>
    ...
    return (
      ...
      <div className="navbar-end">
        <div className="dropdown">
          ...
          >
            <li>
              <Link to={"/"} className=" hover:bg-secondary pr-32">
                Home
              </Link>
            </li>
            <li>
            ...
            <li>
              <Link to={"/"} className=" hover:bg-secondary pr-28">
                Schedule
              </Link>
            </li>
            <li>
            ...
            <li>
              <Link
                to={"/signin"}
                className="btn border-0 lg:flex rounded-full px-10 text-white"
              >
                Sign In
              </Link>
            </li>
