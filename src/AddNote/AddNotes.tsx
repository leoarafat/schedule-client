        ...
        <div className='bg-blue-100 p-10 my-16'>
            <div className='border-2 bg-blue-50 border-dashed border-gray-500 py-10 lg:px-16 px-5 text-2xl text-primary font-bold'>
                ...
                <form onSubmit={handleSubmit(onSubmit)}>
                    <input type="text" {...register("title")} placeholder='Add Title' className='border border-gray-500 input input-bordered w-full mb-3' />
                    <textarea {...register("note")} className="textarea textarea-bordered border-gray-500 w-full h-32" placeholder="What's on your mind?"></textarea>
